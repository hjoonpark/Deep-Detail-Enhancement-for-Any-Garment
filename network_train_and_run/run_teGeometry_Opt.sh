...
# nohup python teGeometry_Opt.py --folder "fear" --start-idx 0 --end-idx 52 --cuda-idx 1 --out-dir output_ours/test > output_ours/test/log_fear1.txt &
# nohup python teGeometry_Opt.py --folder "fear" --start-idx 52 --end-idx 118 --cuda-idx 1 --out-dir output_ours/test > output_ours/test/log_fear2.txt &
# nohup python teGeometry_Opt.py --folder "fear" --start-idx 118 --end-idx 177 --cuda-idx 1 --out-dir output_ours/test > output_ours/test/log_fear3.txt &
# nohup python teGeometry_Opt.py --folder "fear" --start-idx 177 --end-idx 239 --cuda-idx 1 --out-dir output_ours/test > output_ours/test/log_fear4.txt &
